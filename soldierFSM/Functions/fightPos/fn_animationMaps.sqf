...
missionNamespace setVariable ["SFSM_animStances",  SFSM_animStances];
missionNamespace setVariable ["SFSM_rightStances", SFSM_rightStances];
missionNamespace setVariable ["SFSM_leftStances",  SFSM_leftStances];
